...
import { Review } from '../../../public';
import { WbFeedbackGateway } from '../../../public';
import { JsonFileReviewsSink } from '../../../public';
...
//import { ReviewCollection } from '../../../domain/entities/reviewcollection';
...
export class ReviewsService {
  ...
  async fetchReviews(dto: FetchReviewsDto): Promise<FetchReviewsResult> {
    ...
    try {
      // Получаем все отзывы
      const allReviews = await this.fetchAllReviews.execute(productId);
